...
<head>
	...
	<!-- BEGIN PLUGINS CSS -->
    <link rel="stylesheet" href="{ module->path }/theme/assets/globals/plugins/rickshaw/rickshaw.min.css">
    <link rel="stylesheet" href="{ module->path }/theme/assets/globals/plugins/bxslider/jquery.bxslider.css">
...
<body>
	...
	<div class="nav-bar-container">
		...
		<div class="nav-user">
			<div class="user">
				<img src="{ module->path }/theme/assets/globals/img/faces/tolga-ergin.jpg" alt="">
		...
		<div class="overlay">
			...
			<div class="logo">iGitCore</div><!--.logo-->
		</div><!--.overlay-->
						...
						<div class="result result-users">
							...
							<ul class="list-material">
								<li class="has-action-left">
									...
									<a href="#" class="visible">
										<div class="list-action-left">
											<img src="{ module->path }/theme/assets/globals/img/faces/1.jpg" class="face-radius" alt="">
										</div>
								...
								<li class="has-action-left">
									...
									<a href="#" class="visible">
										<div class="list-action-left">
											<img src="{ module->path }/theme/assets/globals/img/faces/10.jpg" class="face-radius" alt="">
										</div>
										<div class="list-content">
								...
								<li class="has-action-left">
									...
									<a href="#" class="visible">
										<div class="list-action-left">
											<img src="{ module->path }/theme/assets/globals/img/faces/11.jpg" class="face-radius" alt="">
										</div>
										<div class="list-content">
						...
						<div class="result result-posts">
							...
							<ul class="list-material">
								<li class="has-action-left">
									...
									<a href="#" class="visible">
										<div class="list-action-left">
											<img src="{ module->path }/theme/assets/globals/img/picjumbo/1.jpg" class="img-radius" alt="">
										</div>
										<div class="list-content">
								...
								<li class="has-action-left">
									...
									<a href="#" class="visible">
										<div class="list-action-left">
											<img src="{ module->path }/theme/assets/globals/img/picjumbo/10.jpg" class="img-radius" alt="">
										</div>
										<div class="list-content">
								...
								<li class="has-action-left">
									...
									<a href="#" class="visible">
										<div class="list-action-left">
											<img src="{ module->path }/theme/assets/globals/img/picjumbo/11.jpg" class="img-radius" alt="">
										</div>
										<div class="list-content">
								...
								<li class="has-action-left">
									...
									<a href="#" class="visible">
										<div class="list-action-left">
											<img src="{ module->path }/theme/assets/globals/img/picjumbo/5.jpg" class="img-radius" alt="">
										</div>
										<div class="list-content">
								...
								<li class="has-action-left">
									...
									<a href="#" class="visible">
										<div class="list-action-left">
											<img src="{ module->path }/theme/assets/globals/img/picjumbo/6.jpg" class="img-radius" alt="">
										</div>
										<div class="list-content">
						...
						<ul class="list-material message-list">
							...
							<li class="has-action-left has-action-right">
								<a href="#" class="visible" data-message-id="4">
									<div class="list-action-left">
										<img src="{ module->path }/theme/assets/globals/img/faces/2.jpg" class="face-radius" alt="">
									</div>
									<div class="list-content">
							...
							<li class="has-action-left has-action-right">
								<a href="#" class="visible" data-message-id="5">
									<div class="list-action-left">
										<img src="{ module->path }/theme/assets/globals/img/faces/12.jpg" class="face-radius" alt="">
									</div>
									<div class="list-content">
							...
							<li class="has-action-left has-action-right">
								<a href="#" class="visible" data-message-id="1">
									<div class="list-action-left">
										<img src="{ module->path }/theme/assets/globals/img/faces/13.jpg" class="face-radius" alt="">
									</div>
									<div class="list-content">
							...
							<li class="has-action-left has-action-right">
								<a href="#" class="visible" data-message-id="2">
									<div class="list-action-left">
										<img src="{ module->path }/theme/assets/globals/img/faces/16.jpg" class="face-radius" alt="">
									</div>
									<div class="list-content">
							...
							<li class="has-action-left has-action-right">
								<a href="#" class="visible" data-message-id="3">
									<div class="list-action-left">
										<img src="{ module->path }/theme/assets/globals/img/faces/17.jpg" class="face-radius" alt="">
									</div>
									<div class="list-content">
						...
						<div class="message-send-container">
							...
							<div class="messages">
								<div class="message left">
									...
									<img src="{ module->path }/theme/assets/globals/img/faces/1.jpg" class="user-picture" alt="">
								</div>
								<div class="message right">
									...
									<img src="{ module->path }/theme/assets/globals/img/faces/tolga-ergin.jpg" class="user-picture" alt="">
								</div>
								<div class="message left">
					...
					<div class="col-md-6 col-md-offset-3">
						...
						<ul class="list-material has-hidden">
							...
							<li class="has-action-left has-action-right has-long-story">
								...
								<a href="#" class="visible">
									<div class="list-action-left">
										<img src="{ module->path }/theme/assets/globals/img/faces/14.jpg" class="face-radius" alt="">
									</div>
									<div class="list-content">
										<span class="caption">Completely synergize resource sucking relationships via premier niche markets. Professionally cultivate one-to-one customer service with robust ideas.</span>
									</div>
    ...
    <script src="{ module->path }/theme/assets/globals/plugins/gmaps/gmaps.js"></script>
    <script src="{ module->path }/theme/assets/globals/plugins/bxslider/jquery.bxslider.min.js"></script>
    <script src="{ module->path }/theme/assets/globals/plugins/audiojs/audiojs/audio.min.js"></script>
    <script src="{ module->path }/theme/assets/globals/plugins/d3/d3.min.js"></script>
    <script src="{ module->path }/theme/assets/globals/plugins/rickshaw/rickshaw.min.js"></script>
    <script src="{ module->path }/theme/assets/globals/plugins/jquery-knob/excanvas.js"></script>
    <script src="{ module->path }/theme/assets/globals/plugins/jquery-knob/dist/jquery.knob.min.js"></script>
    <script src="{ module->path }/theme/assets/globals/plugins/gauge/gauge.min.js"></script>
	<!-- END PLUGINS AREA -->
    ...
    <script src="{ module->path }/theme/assets/globals/scripts/sliders.js"></script>
    <script src="{ module->path }/theme/assets/globals/scripts/maps-google.js"></script>
    <script src="{ module->path }/theme/assets/globals/scripts/widget-audio.js"></script>
    <script src="{ module->path }/theme/assets/globals/scripts/charts-knob.js"></script>
    <script src="{ module->path }/theme/assets/globals/scripts/index.js"></script>
